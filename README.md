...
|---|---|
| Version | 0.1.0 |
| Written against | the filex **v0.43.0** catalogue (`catalogue/`, 3,588 strings — 1,774 admin, 1,529 explorer, 227 the server's, 58 drawn by both) |
| Coverage | 100 % — 3,588 of 3,588 strings, plus 1 extra plural form |
